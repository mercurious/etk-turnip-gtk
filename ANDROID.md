...
|---|---|---|
| `etk-turnip-26.2.0-android.adpkg.zip` | **Stable.** Built from an official Mesa release. | You want it to just work. **Start here.** |
...
The number (`26.2.0`) is the Mesa version — bigger is newer. The letters and
